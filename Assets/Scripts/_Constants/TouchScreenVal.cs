...
public class TouchScreenVal : System.Object {
	...
	public bool OnTouchPress(){
		...
		Debug.Log("inside touch press"+Input.touchCount);
		bool res = false;
	...
	public Vector2 OnTouchDirection(bool fixdrag){
		...
		Debug.Log("inside touch direction"+Input.touchCount);
	...
	public Vector2 OnDragDirection(bool fixdrag){
		...
		Debug.Log("inside drag direction"+Input.touchCount);
